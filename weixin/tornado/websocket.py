...
from weixin.concurrent import TracebackFuture
from weixin.escape import utf8, native_str, to_unicode
from weixin import httpclient, httputil
from weixin.ioloop import IOLoop
from weixin.iostream import StreamClosedError
from weixin.log import gen_log, app_log
from weixin import simple_httpclient
from weixin.tcpclient import TCPClient
from weixin.util import _websocket_mask
...
class WebSocketHandler(weixin.web.RequestHandler):
    ...
    def __init__(self, application, request, **kwargs):
        weixin.web.RequestHandler.__init__(self, application, request,
                                           **kwargs)
    ...
    def get(self, *args, **kwargs):
        ...
        if self.ws_connection:
            ...
            if not self.stream.closed():
                self.stream.write(weixin.escape.utf8(
    ...
    def write_message(self, message, binary=False):
        ...
        if isinstance(message, dict):
            message = weixin.escape.json_encode(message)
...
class _PerMessageDeflateCompressor(object):
    ...
    def _create_compressor(self):
        return zlib.compressobj(weixin.web.GZipContentEncoding.GZIP_LEVEL,
...
class WebSocketProtocol13(WebSocketProtocol):
    ...
    def write_message(self, message, binary=False):
        ...
        if binary:
            ...
            opcode = 0x1
        message = weixin.escape.utf8(message)
