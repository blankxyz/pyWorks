...
from weixin.httpclient import HTTPError, HTTPRequest
from weixin.log import gen_log, app_log
from weixin.testing import AsyncHTTPTestCase, gen_test, bind_unused_port, ExpectLog
from weixin.test.util import unittest
from weixin.web import Application, RequestHandler
from weixin.util import u

try:
    import weixin.websocket  # noqa
    from weixin.util import _websocket_mask_python
except ImportError:
...
from weixin.websocket import WebSocketHandler, websocket_connect, WebSocketError

try:
    from weixin import speedups
except ImportError:
    speedups = None
