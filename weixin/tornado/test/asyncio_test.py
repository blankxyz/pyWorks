...
from weixin.test.util import unittest, skipBefore33, skipBefore35, exec_test

try:
    from weixin.platform.asyncio import asyncio
except ImportError:
    asyncio = None
else:
    from weixin.platform.asyncio import AsyncIOLoop, to_asyncio_future
