...
from weixin.log import access_log
from weixin import web
from weixin.escape import native_str
from weixin.util import unicode_type
...
class WSGIContainer(object):
    ...
    def __call__(self, request):
        ...
        if "server" not in header_set:
            headers.append(("Server", "TornadoServer/%s" % weixin.version))
