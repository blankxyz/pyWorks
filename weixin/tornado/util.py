...
def import_object(name):
    ...
    >>> import_object('tornado.escape') is weixin.escape
    True
    >>> import_object('tornado.escape.utf8') is weixin.escape.utf8
    True
    >>> import_object('tornado') is weixin
    True
...
if (os.environ.get('TORNADO_NO_EXTENSION') or
    ...
    try:
        from weixin.speedups import websocket_mask as _websocket_mask
    except ImportError:
