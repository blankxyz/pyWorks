...
from weixin.concurrent import TracebackFuture, is_future
from weixin.log import app_log, gen_log
from weixin import stack_context
from weixin.util import Configurable, errno_from_exception, timedelta_to_seconds
...
from weixin.platform.auto import set_close_exec, Waker
...
class IOLoop(Configurable):
    ...
    def configurable_default(cls):
        if hasattr(select, "epoll"):
            from weixin.platform.epoll import EPollIOLoop
            return EPollIOLoop
        if hasattr(select, "kqueue"):
            # Python 2.6+ on BSD or Mac
            from weixin.platform.kqueue import KQueueIOLoop
            return KQueueIOLoop
        from weixin.platform.select import SelectIOLoop
        return SelectIOLoop
        ...
        def run():
            try:
                ...
                if result is not None:
                    from weixin.gen import convert_yielded
