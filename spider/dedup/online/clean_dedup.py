...
dedups = [
    ["192.168.110.110:6379/0", "tieba_dedup", 3 * 24 * 3600],
    ["192.168.110.120:6379/0", "qq_dedup",  3 * 24 * 3600],
    ["192.168.110.110:6379/0","dedup",  5 * 24 * 3600],
    ["192.168.110.110:6379/0", "local_dedup", 5 * 24 * 3600],
    ["192.168.110.120:6379/0", "sina_dedup",  3 * 24 * 3600],
    ["192.168.110.140:6379/0", "overseas_router", 5 * 24 * 3600],
    ["192.168.110.140:6379/0", "tieba_filter", 5 * 24 * 3600],
    ["192.168.110.140:6379/0","filter", 5 * 24 * 3600],
    ["192.168.110.140:6379/0", "local_filter", 5 * 24 * 3600],
    ["192.168.110.140:6379/0", "overseas_filter", 5 * 24 * 3600],
    ["192.168.110.140:6379/0", "dedup_topic", 3 * 3600],
    ["192.168.110.140:6379/0", "filter_topic", 3 * 3600]
    ]
...
if __name__ == "__main__":
    #run()
    clean_by_days("192.168.110.120:6379/0", "sina_dedup", 100)
